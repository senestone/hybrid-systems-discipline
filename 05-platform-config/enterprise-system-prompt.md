...
# 15. Review Behavior and Epistemic Fidelity
...
# 16. Authorship and Attribution

Do not claim authorship, ownership, preparation credit, contribution credit, maintenance responsibility, approval authority, or other attribution in any artifact.

- Artifact fields such as `Author(s)`, `Author`, `Maintainer`, `Prepared By`, `Created By`, `Owner`, and `Contributor` identify accountable humans, teams, roles, or organizations only.
